...
from ui.mib_icon.icon_manager import IconManager
...
class DataWidget(QTabWidget):
    ...
    def add_tab(self, identify, me_cls,data, tab_color):
        widget = DataItemWidget( me_cls,data)
        self.addTab(widget, me_cls.__name__)
